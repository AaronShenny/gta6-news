...
## FAQ
**Have GTA 6 title IDs been added to the PlayStation database?**
Yes, title IDs for Grand Theft Auto 6 have reportedly been added to the PlayStation database, according to the X account PlayStation Game Size.

**Does this mean GTA 6 preorders are starting soon?**
The addition of title IDs to the PlayStation database often serves as a precursor to preorder sales or other significant store page updates, leading to speculation that preorders may open soon.

**Why does GTA 6 have two title IDs?**
The reason for two title IDs is currently a mystery. While some speculate about different game editions, PlayStation Game Size indicates that different editions usually share the same ID. One theory suggests the second ID could be for a standalone GTA 6 Online app.

**When is GTA 6 expected to be released?**
Rockstar's parent company, Take-Two, has confirmed that GTA 6 is on track for a November 19 release date.

**When will the GTA 6 marketing campaign begin?**
The marketing campaign for Grand Theft Auto 6 is set to kick off this summer.


[Read full article](https://www.gamespot.com/articles/gta-6-reportedly-added-to-playstation-database-igniting-preorder-speculation/1100-6538494/?ftag=CAD-01-10abi2f)

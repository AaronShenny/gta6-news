...
## FAQ
**Why did Randy Pitchford post an AI-generated selfie?**
He intended to highlight the 'absurdity of the idea of AI having an identity' by prompting an AI to generate a picture of itself working at Gearbox Software.

**What is Gearbox's policy on AI in game development?**
Gearbox has a strict policy: 'no AI in any work that could ever be seen by any customer.'

**Does Take-Two, Gearbox's parent company, use AI in its business operations?**
Yes, Take-Two is implementing AI systems across its business to drive efficiencies in non-creative areas.

**Will generative AI be used in GTA 6?**
No, Take-Two CEO Strauss Zelnick explicitly stated that generative AI has 'zero part' in GTA 6 development.

**Did Gearbox use AI for Borderlands patch notes?**
Randy Pitchford denied any connection between his AI post and fan theories about AI-written patch notes, stating the timing was coincidental.


[Read full article](https://www.gamespot.com/articles/borderlands-studio-head-responds-after-fans-rip-him-for-ai-slop-selfie/1100-6539764/?ftag=CAD-01-10abi2f)
